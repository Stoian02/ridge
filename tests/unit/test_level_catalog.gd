...
func test_rock_canyon_is_fourth_and_unlocks_after_frozen_pass() -> void:
	...
	assert_eq(canyon.two_star_time, 180.0, "owner-approved target: under 3:00")
	assert_eq(canyon.three_star_time, 145.0, "owner-approved target: under 2:25, the owner's best")
