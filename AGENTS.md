...
**Current handoff:** read `docs/notes/loose-rock-shelf-2026-09-19.md` first.
...
The implementation is awaiting their PC playtest, not release acceptance.
...
finish after CP5 and the accepted earlier sections. Stop for owner feedback.
